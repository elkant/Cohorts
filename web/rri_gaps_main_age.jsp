...
<form action="baselinereport" id="reportingForm">
        ...
        <script type="text/javascript" src="gaps/sum_values_age.js"></script>
        <script type="text/javascript" src="gaps/validation_age.js"></script>
