...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="images/ahd.png">
        ...
        <div id="top-nav" class="navbar navbar-inverse navbar-static-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    <button id="toolid" style="float:left;color:white; text-align: center;" class="navbar-toggle btn btn-default" >&nbsp;AHD Module</button>
...
<form action="ahdreported" id="reportingForm">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select class="form-control input-sm" onchange="checkFormAction();"   name='report' id='report' >
                                                            <option value='ahdreported'>1.Reported Data</option>
                                                            <option value='ahd_missing_reports'>2.missing Reports</option>
        ...
        <script type="text/javascript" src="ahd/sum_values.js"></script>
        <script type="text/javascript" src="ahd/validation.js"></script>
...
var m5=$("#"+indicatorid+"_5m").val();
var f5=$("#"+indicatorid+"_5f").val();
var m14=$("#"+indicatorid+"_14m").val();
var f14=$("#"+indicatorid+"_14f").val();
var m15=$("#"+indicatorid+"_15m").val();
var f15=$("#"+indicatorid+"_15f").val();
...
console.log("yearmonth:"+ym);
                                           //now load the data
                                           $.ajax({
                                               url: 'ahd_getIndicators?ym=' + ym + "&fc=" + fc,
                                               type: 'post',
                                               dataType: 'html',
                                               success: function (data)
                                               {
