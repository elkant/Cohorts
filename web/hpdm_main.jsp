        ...
        <div id="top-nav" class="navbar navbar-inverse navbar-static-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    <button id="toolid" style="float:left;color:white; text-align: center;" class="navbar-toggle btn btn-default" >&nbsp;HPDM Module</button>
...
<form action="hpdmreported" id="reportingForm">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select class="form-control input-sm" onchange="checkFormAction();"   name='report' id='report' >
                                                            <option value='hpdmreported'>1.Reported Data</option>
                                                            <option value='hpdmtracker'>2.missing and Submitted Reports</option>
        ...
        <script type="text/javascript" src="hpdm/sum_values.js"></script>
        <script type="text/javascript" src="hpdm/validation.js"></script>
...
var m_14=$("#"+indicatorid+"_m_14").val();
var f_14=$("#"+indicatorid+"_f_14").val();

var m_19=$("#"+indicatorid+"_m_19").val();
var f_19=$("#"+indicatorid+"_f_19").val();

var m_29=$("#"+indicatorid+"_m_29").val();
var f_29=$("#"+indicatorid+"_f_29").val();

var m_39=$("#"+indicatorid+"_m_39").val();
var f_39=$("#"+indicatorid+"_f_39").val();

var m_49=$("#"+indicatorid+"_m_49").val();
var f_49=$("#"+indicatorid+"_f_49").val();

var m_50=$("#"+indicatorid+"_m_50").val();
var f_50=$("#"+indicatorid+"_f_50").val();
...
console.log("yearmonth:"+ym);
                                           //now load the data
                                           $.ajax({
                                               url: 'hpdm_getIndicators?ym=' + ym + "&fc=" + fc,
                                               type: 'post',
                                               dataType: 'html',
                                               success: function (data)
                                               {
