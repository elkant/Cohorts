            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title" style="text-align: center;">
                    <a class='btn-warning btn' href="pns/ART Daily Form v4 2020_03_20.xlsx" style="margin-left:40%;">Download ART Daily Template</a> 
<!--                    Internal System-->
                  </h3>
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        ...
                        <a href="#" style="margin-left:40%;">Upload ART daily Data v4 (20 Mar 2020).</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="importderv4" method="post" enctype="multipart/form-data" class="form-horizontal" >
