...
<head>
   <meta charset="utf-8" />
   <title>Upload New and Defaulters Adherence Cohort</title>
   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h1 style="text-align:center;font-size: 50px;color:white;padding-bottom:16px ;font-weight: bolder;">New and Defaulters Adherence Cohort</h1><br/>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">Upload New and Defaulters Adherence Cohort excel file.</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="importndefaulter" method="post" enctype="multipart/form-data" class="form-horizontal" >
                        ...
                        <br><br><br><br>
                           ...
                           <div class="form-actions">
                              <button type="submit" class="btn blue">Upload Defaulters Excel.</button>
...
<script > 
 ...
 <%if (session.getAttribute("uploadeddefaulter") != null) { %>
                                <script type="text/javascript"> 
                    
                    
                    $("#matokeo").html('<%=session.getAttribute("uploadeddefaulter")%>');
                         
      $.notify(
      {
  message:'<%=session.getAttribute("uploadeddefaulter")%>'},
      {
	icon_type: 'image'
      }, 
      {
