...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Clients Eligible For VL</title>
        ...
        <div id="top-nav" class="navbar navbar-inverse navbar-static-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    <button id="toolid" style="float:left;color:white; text-align: center;" class="navbar-toggle btn btn-default" >&nbsp;Eligible Not Done For VL Report</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                ...
                                <div class='btn-default'><h4 style='text-align:center;padding:10px;'><b>Tracking Eligible Clients Not Done for VL  </b></h4></div>
                                ...
                                <ul class="nav nav-tabs " id="myTab">
                                    ...
                                    <li><a href="Eligible Clients Not Done For VL as at May 2024.xlsx"  style="background-color:orange;color:white;" id="dailyartExcelbutton" > <i class="glyphicon glyphicon-download"></i>Download Patients Linelist</a></li> 
...
String qr="select GROUP_CONCAT(DISTINCT(category)) as Category from internal_system.eligibleforvl_indicators;";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col-xs-4">
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <label><required-option></required-option>Eligible Clients not Done for VL as at</label> 
                                                            ...
                                                            <td class="col-xs-4">
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        <select onchange="isdisplayindicators();" readonly  required type="text"  title="this is the reporting date"  class="form-control input-sm dates" name="period" id="period" autocomplete="off">
                                                                            <option value="2024-05-31">May 2024</option>
                                                                            <option value="2024-04-30">April 2024</option>
                                                                        </select>                                         
...
<form action="retreported" id="reportingForm">
        ...
        <script type="text/javascript" src="eligiblenotdoneforvl/sum_values.js"></script>
        <script type="text/javascript" src="eligiblenotdoneforvl/validation.js"></script>
...
var _9=$("#"+indicatorid+"__9").val();
var _14=$("#"+indicatorid+"__14").val();
var _19=$("#"+indicatorid+"__19").val();
var _24=$("#"+indicatorid+"__24").val();
var _25=$("#"+indicatorid+"__25").val();
var pbfw=$("#"+indicatorid+"_pbfw").val();
...
console.log("yearmonth:"+ym);
                                           //now load the data
                                           $.ajax({
                                               url: 'getEligibleIndicators?ym=' + ym + "&fc=" + fc+"&sdp="+sdp,
                                               type: 'post',
                                               dataType: 'html',
                                               success: function (data)
                                               {
