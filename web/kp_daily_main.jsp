...
<!--    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h5 class="btn btn-default col-md-12" style="text-align: center;color:blue;"><b>KP Daily Reporting Module</b></h5>
...
//    console.log("_"+fc+"vs"+dt);
    ...
    $("#dynamicindicators").show();    
            ...
            //now load the data
          $.ajax({
                    url:'getKPDailyIndicators?dt='+dt+"&fc="+fc,                            
                    type:'post',  
                    dataType: 'html',  
                    success: function(data) 
                    {
