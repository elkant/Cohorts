                        ...
                        <div class="panel-body" style="width:100%;">
                            <form class="form form-vertical"  action="#" method="post" id="weeklydataform">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label><font color="red"><b>*</b></font> LIP </label> 
                               ...
                               <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <input onchange="isdisplayindicators();" readonly data-date-end-date="0d" required type="text" value='' title="this is the reporting date" value="" class="form-control input-sm dates" name="reportingdate" id="reportingdate" autocomplete="off">
