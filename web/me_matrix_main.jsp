...
<html>
	<head>
		...
		<link href="css/bootstrap.css" rel="stylesheet">
                ...
                <link rel="shortcut icon" href="images/me_matrix.png">
                 ...
                 <li>
                  <a  title="Help" data-toggle="modal" href="#help">
                            ...
                            Help
                              ...
                              <li><a style="text-align: center;" href='me_matrix_index.jsp'><i class="glyphicon glyphicon-log-out"></i> Logout</a></li>
            </ul>
        </div>
...
<!--    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h5 class="btn btn-default col-md-12" style="text-align: center;color:blue;"><b>M&E Matrix Monthly Reporting Module</b></h5>
                    ...
                    <div class="panel panel-default">
                      ...
                      <!-------Data Management ---------->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col-xs-6">
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <label><required-option></required-option>Cluster</label> 
                                ...
                                <div class="control-group col-xs-12">
                                   ...
                                   <br/>
                                    <div class="controls">
                                        <input readonly type="input" onClick="validatedata();"  id='savebutton' value="SAVE"  style="margin-left: 0%;" class="btn-lg btn-success active">
                                            
                                     </div>
                                     <div class="controls">
                                        <button readonly type="submit" id='updatebutton' onclick="updateweeklydata();" style="margin-left: 0%;display:none;" class="btn-lg btn-info active">
                                            UPDATE 
                                        </button>
                                    </div>
...
<form action="me_matrix_reports" id="reportingForm">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select class="form-control input-sm" onchange="checkFormAction();"   name='report' id='report' >
                                                            <option value='me_matrix_reports'>2.Reported Data</option>
...
daterange=yearmonth+" to "+yearmonth;
...
//    console.log("_"+fc+"vs"+dt);
    ...
    $("#dynamicindicators").show();    
            ...
            //now load the data
          $.ajax({
                    url:'getMatrixIndicators?dt='+dt+"&fc="+fc,                            
                    type:'post',  
                    dataType: 'html',  
                    success: function(data) 
                    {
