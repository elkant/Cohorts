...
<html lang="en">
<head>
	<title>Retention Audit Module</title>
	<meta http-equiv="content-type" content="text/html; charset=UTF-8">
		<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
<link rel="icon" type="image/png" href="images/retention.png"/>
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-3 p-b-20">
				<form action='retention_login' class="login100-form validate-form">
					<h3 style="text-align: center;">Retention Audit Module</h3>
                                        <hr>
					<span class="login100-form-avatar">
                                            <img src="images/retention.png" alt="welcome">
					</span>
