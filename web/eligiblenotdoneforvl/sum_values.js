...
var columns = ["_9","_14","_19","_24","_25"];
...
var agesets = ["_9","_14","_19","_24","_25","_pbfw"];
//    var indicator_id=document.getElementById("indic_pos_"+indic_pos).value;
//    alert(indicator_id);
...
var agesets = ["_9","_14","_19","_24","_25","pbfw","value"];
//    var indicator_id=document.getElementById("indic_pos_"+indic_pos).value;
//    alert(indicator_id);
...
function isNumber(n) {
 ...
 function removeFirstZero(elem){
       ...
       function validatePbfw(indic){
           var pbfw=document.getElementById(indic+"_pbfw").value;
           var ttl=document.getElementById(indic+"_value").value;
           if(ttl===''){ttl=0;}
           
           if((pbfw!==''&&pbfw!=='0')){
               if(parseInt(pbfw)>parseInt(ttl)){
                 
                   $("#savebutton").hide();
                   redbordercl(indic+"_pbfw");
                   redbordercl(indic+"_value");
                    $("#fedback").html("Validation Error!. PMTCT Values cannot be more than the total values");
               }
               else {
                    blackbordercl(indic+"_pbfw");
                   blackbordercl(indic+"_value");
                     $("#savebutton").show();
                       $("#fedback").html("");
