...
<head>
   <meta charset="utf-8" />
   <title>STF/New Defaulter Adherence Reports</title>
   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h1 style="text-align:center;font-size: 50px;color:white;padding-bottom:16px ;font-weight: bolder;">STF / New Defaulters Adherence Reports</h1><br/>
...
<!--                    Internal System-->
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        <i class="icon-home"></i>
                        <a href="#" style="margin-left:40%;">Generate Reports</a> 
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
                                  <select required type="text" title="" onchange='selectoutput();'  class="form-control input-lg" name="output" id="output" >
                                      ...
                                      <option value='stf_newdefaulter'>Reports</option>
                              ...
                              <div class="control-group" id='pepfardiv' style="display:none;">
