            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title" style="text-align: center;">
                         <a class='btn-warning btn' href="pns/PNSIndexweeklyTemplate20181019Version200.xlsx" style="margin-left:40%;">Download PNS Weekly Template</a> 
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>  Note: This module accepts data up to date 3rd of May 2019. From there, uploads should be done <a class='btn btn-warning' href='importpns.jsp'>daily</a>, starting from 13th May 2019.</h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="importpnsv2" method="post" enctype="multipart/form-data" class="form-horizontal" >
                        ...
                        <table style="width: 100%;">
                           <tr><td class="col-xs-2">
                            <div class="form-actions">
                              <button class='btn btn-success btn-large' type="submit" class="btn blue">Upload PNS Weekly file.</button>
...
%>
     ...
     <h4 class="portlet-title" style="text-align: center;color:black;"> &copy; AfyaNyota | USAID <%=year%>. Host Name :<b></b> &nbsp;</h4>
