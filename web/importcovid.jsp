   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="navbar-inner">
         <div class="container-fluid">
            <!-- BEGIN LOGO -->
            <h1 style="text-align:center;font-size: 50px;color:white;padding-bottom:16px ;font-weight: bolder;">Covid 19 Form Upload</h1><br/>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title" style="text-align: center;">
                    <a class='btn-warning btn' href="pns/covid19_impact_form.xlsx" style="margin-left:40%;">Download Template</a> 
<!--                    Internal System-->
                  </h3>
                  ...
                  <ul class="breadcrumb">
                     <li style="width: 900px;">
                        ...
                        <a href="#" >Upload Covid 19 Indicators (20 Mar 2020).</a> 
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title " style="background-color: orange;">
                     <h4 ><i class="icon-reorder"></i>Ensure that the excel template name ends with <b>.xlsx</b> and that all sheets with data have MFLCode</h4>
                       
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="importcovid" method="post" enctype="multipart/form-data" class="form-horizontal" >
...
//        alert("data submitted");
     ...
     function load_records(){
             ...
             $.ajax({
        url:'checkstatus?load_type=covid',
        type:"post",
        dataType:"json",
