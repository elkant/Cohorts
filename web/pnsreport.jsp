                     ...
                     <div class="portlet-body form">
                        ...
                        <form action="importpns" method="post" enctype="multipart/form-data" class="form-horizontal" >
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                  <input required type="text" title="this is the date that the week started" value="2017-10-01" class="form-control input-lg tarehe" name="weekstart" autocomplete="off" id="weekstart">
                              </div>
                           </div>
