...
<html lang="en">
<head>
	<title>RRI Gaps tracking Module</title>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-3 p-b-20">
				<form action='rri_gaps_login' class="login100-form validate-form">
					<h3 style="text-align: center;">RRI Service Gaps Module</h3>
                                        <hr>
					<span class="login100-form-avatar">
                                            <img src="images/rri.png" alt="welcome">
					</span>
