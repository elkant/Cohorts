...
<head>
   <meta charset="utf-8" />
   <title>Afya Nyota HFR Reports </title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!--                  <ul class='btn btn-success' >
                     <li >
                        -->
                        <label style='background-color:#66ff66;border: green;' class='btn btn-primary btn-sm btn-rounded'><i class="icon-backward"></i><a  href='hfr.jsp'> Back to data entry</a></label>
                        <!--<span class="icon-angle-right"></span>-->
<!--                     </li>
