...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Micare & Lift Up Data</title>
        ...
        <div id="top-nav" class="navbar navbar-inverse navbar-static-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    <button id="toolid" style="float:left;color:white; text-align: center;" class="navbar-toggle btn btn-default" >&nbsp;Micare Report</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                ...
                                <div class='btn-default'><h4 style='text-align:center;padding:10px;'><b>MiCARE and LIFT UP Data Reporting</b></h4></div>
...
String qr="select GROUP_CONCAT(DISTINCT(category)) as Category from internal_system.micare_liftup_indicators;";
...
String so="<option value=''>Select Population type</option>";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col-xs-4">
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <label><required-option></required-option>Population Type</label> 
                                                            ...
                                                            <td class="col-xs-4">
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <label><required-option></required-option>Dic/Facility</label> 
...
<form action="retreported" id="reportingForm">
        ...
        <script type="text/javascript" src="micare/sum_values.js"></script>
        <script type="text/javascript" src="micare/validation.js"></script>
...
console.log("yearmonth:"+ym);
                                           //now load the data
                                           $.ajax({
                                               url: 'getMiLiIndicators?ym=' + ym + "&fc=" + fc+"&sdp="+sdp,
                                               type: 'post',
                                               dataType: 'html',
                                               success: function (data)
                                               {
