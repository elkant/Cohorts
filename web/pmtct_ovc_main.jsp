...
<!--                            
                    ...
                    <div class="panel">
                        <ul class="nav nav-tabs " id="myTab">
                            ...
                            <li class="active newdata"> <a href="#editmother" id="editmotherdatabutton" data-toggle="tab">  <i class="glyphicon glyphicon-edit"> </i> <font color='green'><b>Edit</b></font> Mothers</a></li>
