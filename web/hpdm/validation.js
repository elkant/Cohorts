...
var agearray= ["m_14","f_14","m_19","f_19","m_29","f_29","m_39","f_39","m_49","f_49","m_50","f_50"];
...
//    alert(indicator_id);
    ...
    for (var i = 0; i < columns.length; i++) {
        ...
        val2 = multisum(valarray[1], columns[i]);
         console.log("Kwa greater:"+valarray[0]+"  "+columns[i]);
         console.log("Kwa greater:"+valarray[1]+"  "+columns[i]);
        console.log("Kwa greater:"+val1+"  "+val2);
...
//    alert(indicator_id);
    ...
    for (var i = 0; i < columns.length; i++) {
        ...
        val1 = multisum(valarray[0], columns[i]);
        val2 = multisum(valarray[1], columns[i]);
        console.log("Greater than"+valarray[0], columns[i]);
        console.log(valarray[1], columns[i]);
