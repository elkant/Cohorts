 ...
 * @author EKaunda
 */
public class cirg_kp_ppmsreport extends HttpServlet {
...
//        }
       ...
       String ym=startdate.replace("-","").substring(0,6);
        ...
        String storedprocedurename=" call internal_system.sp_ppms_cirg_key_population('"+startdate+"','"+enddate+"');";
...
rw.setHeightInPoints(26);
        ...
        System.out.println("" + "CIRG_KP_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "Key-Populations_-_USAID_Tujenge_Jamii_"+ym+"_" + createdOn.trim() + ".xlsx");
