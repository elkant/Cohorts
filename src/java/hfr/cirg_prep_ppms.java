 ...
 * @author EKaunda
 */
public class cirg_prep_ppms extends HttpServlet {
...
//        }
       ...
       String ym=startdate.replace("-","").substring(0,6);
        ...
        String storedprocedurename=" call internal_system.sp_ppms_cirg_prep('"+startdate+"','"+enddate+"');";
...
rw.setHeightInPoints(26);
      ...
      //  shet.createFreezePane(6, 0);
        ...
        System.out.println("" + "CIRG_Prep_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "Prep_-_USAID_Tujenge_Jamii_"+ym+"_" + createdOn.trim() + ".xlsx");
