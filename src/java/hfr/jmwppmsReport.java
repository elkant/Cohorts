 ...
 * @author EKaunda
 */
public class jmwppmsReport extends HttpServlet {
...
//        }
       ...
       String ym=startdate.replace("-","").substring(0,6);
        ...
        String storedprocedurename=" call internal_system.sp_ppms_jmw('"+startdate+"','"+enddate+"');";
...
rw.setHeightInPoints(26);
        ...
        System.out.println("" + "JMW_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "JMW-Monthly_-_USAID_Tujenge_Jamii_"+ym+"_" + createdOn.trim() + ".xlsx");
