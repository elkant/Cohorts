 ...
 * @author EKaunda
 */
public class savehfr extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table=" pews.hfr_table_20 ";
          
          String mfl="";
          
          if(request.getParameter("facility_mfl_code")!=null){
          mfl=request.getParameter("facility_mfl_code");
          
          }
            
 String[] dataelementsarr= {"id","organisationunitid","ward","date","daterange","facility","facility_mfl_code","indicator","bl15_Male","bl15_Female","ab15_Male","ab15_Female","reporting_freq","operatingunit","fundingagency","partner","mechanismid"}; 
...
{
   out.println("HFR Data Saved succesfully ");
}
else {
 out.println(" Data Not saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(savehfr.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
