 ...
 * @author EKaunda
 */
public class loadRamcahSites extends HttpServlet {
   ...
   HttpSession session;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String getfacils="select * from internal_system.subpartnera ";
            ...
            String facilname=conn.rs.getString("khisname");
...
facil+="<option "+selectedval+"  value=\""+subpartnerid+"\">"+facilname+" - "+mflcode+"</option>";
