 ...
 * @author EKaunda
 */
public class stf_newdefaulter extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        XSSFSheet acashet = wb.createSheet("STF raw Data");
        XSSFSheet mcashet = wb.createSheet("New Defaulter raw Data");
        
        XSSFSheet Sheetnames[]={acashet,mcashet};
...
//        }
        ...
        shet.addMergedRegion(new CellRangeAddress(1, 1, 0,10));
              ...
              //shet.getSheetName();
                ...
                if(shet.getSheetName().equals("STF raw Data")){
                
                storedprocedure="rpt_STF";
                }
                else { 
                
                 storedprocedure="rpt_newDefaulter";
                }
...
rw.setHeightInPoints(26);
        ...
        System.out.println("" + "STF_New_Defaulter_rpt_from_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "STF_New_Defaulter_rpt_from_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
