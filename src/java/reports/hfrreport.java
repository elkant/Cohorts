...
//______________________________________________________________________________________  
        ...
        XSSFSheet shet = wb.createSheet("Afya_Nyota_HFR Report");
...
rw.setHeightInPoints(26);
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "AfyaNyota_HFR_rpt_for_"+startdate+"_to_"+enddate+"__gen_" + createdOn.trim() + ".xlsx");
