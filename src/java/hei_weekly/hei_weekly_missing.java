 ...
 * @author EKaunda
 */
public class hei_weekly_missing extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "Missing_HEI_Weekly_Status@internal_system.sp_hei_weekly_missing_reports");
...
rw.setHeightInPoints(32);
        ...
        System.out.println("" + "UPI_Status_Tracker_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "UPIStatus_Tracker_rpt_for_"+enddate+"__gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(hei_weekly_missing.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
