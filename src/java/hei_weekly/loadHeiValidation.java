 ...
 * @author EKaunda
 */
public class loadHeiValidation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getList="select * from internal_system.hei_weekly_validation where is_active='1'  ";
           ...
           arr.add(obj);
            ...
            Logger.getLogger(loadHeiValidation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
                  }
    }
