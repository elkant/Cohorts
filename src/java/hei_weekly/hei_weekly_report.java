 ...
 * @author EKaunda
 */
public class hei_weekly_report extends HttpServlet {
...
String allpath = getServletContext().getRealPath("/hei_weekly_reports.xlsx");
...
String filepath="HEI_WEEKLY_"+dat2+".xlsx";
...
//                    
        ...
        String qry = "call internal_system.sp_pull_hei_weekly_report('"+startdate+"', '"+enddate+"');";
...
wb.setForceFormulaRecalculation(true);
        System.out.println("" + "Hei_Weekly_Reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "Hei_weekly_Reports_btwn_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(hei_weekly_report.class.getName()).log(Level.SEVERE, null, ex);
