 ...
 * @author EKaunda
 */
public class saveHei extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table=" internal_system.hei_weekly_data ";
 ...
 String[] dataelementsarr= {"id","date","facility","indicatorid","ttl","userid"}; 
...
{
   out.println("Hei Weekly Data Saved succesfully ");
}
else 
{
 out.println(" Data Not successfully saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveHei.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
