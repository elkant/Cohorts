 ...
 * @author EKaunda
 */
public class saveRet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table="internal_system.ret_data";
...
//          }
 ...
 String[] dataelementsarr= {"id","yearmonth","facility","indicatorid","_9m","_9f","_14m","_14f","_19m","_19f","_24m","_24f","_25m","_25f","ttl","userid"}; 
 String[] destelementsarr= {"id","yearmonth","facility","indicatorid","9m","9f","14m","14f","19m","19f","24m","24f","25m","25f","ttl","userid"}; 
...
{
   out.println("Retention Audit Saved succesfully ");
}
else {
 out.println(" Data Not saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveRet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
