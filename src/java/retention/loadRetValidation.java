 ...
 * @author EKaunda
 */
public class loadRetValidation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getList="select * from internal_system.ret_validation where is_active='1'  ";
           ...
           arr.add(obj);
            ...
            Logger.getLogger(loadRetValidation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
                  }
    }
