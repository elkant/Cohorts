 ...
 * @author EKaunda
 */
public class retentiontracker extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "Missing_Retention_Audit@internal_system.sp_retention_missing_tracker");
        sps.put(2, "Submitted_Retention_Audit@internal_system.sp_retention_submitted_tracker");
...
rw.setHeightInPoints(32);
        ...
        System.out.println("" + "RetentionTracker_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "Retention_Reports_Tracker_rpt_from_"+startdate+"_to_"+enddate+"__gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(retentiontracker.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
