 ...
 * @author EKaunda
 */
public class gapsreported extends HttpServlet {
...
String allpath = getServletContext().getRealPath("/gapsreported.xlsx");
...
//                    
        ...
        String qry = "call internal_system.sp_rri_gaps_accounted_for_Report('"+startdate+"', '"+enddate+"');";
...
ctTable.setRef("A1:L" + (shet.getLastRowNum() + 1)); // adjust reference as needed
        ...
        System.out.println("" + "Service_Gaps_Reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "Service_Gaps_Reports_btwn_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
