 ...
 * @author EKaunda
 */
public class saveEligiblenotdoneforvl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table="internal_system.eligibleforvl_data";
...
//          }
 ...
 String[] dataelementsarr= {"id","date","facility","indicatorid","sdp","_9","_14","_19","_24","_25","pbfw","value","userid","date"}; 
 String[] destelementsarr= {"id","date","mflcode","indicator_id","delivery_point","_9","_14","_19","_24","_25","pbfw","value","submitted_by","datefromfile"}; 
...
{
   out.println("Eligible not Done For VL  data Saved succesfully ");
}
else {
 out.println(" Data Not saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveEligiblenotdoneforvl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
