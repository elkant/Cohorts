 ...
 * @author EKaunda
 */
public class loadEligibleNotDoneForVlValidation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getList="select * from internal_system.dailyart_validation where is_active='1';";
           ...
           arr.add(obj);
            ...
            Logger.getLogger(loadEligibleNotDoneForVlValidation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
                  }
    }
