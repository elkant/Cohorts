 ...
 * @author EKaunda
 */
public class loadStockSites extends HttpServlet {
   ...
   HttpSession session;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String getfacils="select * from internal_system.subpartnera where stockv=1 ";
...
facil+="<option  value=\""+subpartnerid+"\">"+facilname+" - "+mflcode+"</option>";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           ...
           Logger.getLogger(loadStockSites.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
