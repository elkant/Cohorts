 ...
 * @author EKaunda
 */
public class loadAhdValidation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getList="select * from internal_system.ahd_validation where is_active='1'  ";
           ...
           arr.add(obj);
            ...
            Logger.getLogger(loadAhdValidation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
                  }
    }
