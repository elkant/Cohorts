 ...
 * @author EKaunda
 */
public class saveAhd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table="internal_system.ahd_data";
...
//          }
 ...
 String[] dataelementsarr= {"id","yearmonth","facility","indicatorid","_5m","_5f","_14m","_14f","_15m","_15f","_pbfw","ttl","userid"}; 
 String[] destelementsarr= {"id","yearmonth","facility","indicatorid","5m","5f","14m","14f","15m","15f","pbfw","ttl","userid"}; 
...
{
   out.println("Ahd Saved succesfully ");
}
else {
 out.println(" Data Not saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveAhd.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
