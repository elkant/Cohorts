 ...
 * @author EKaunda
 */
public class upiReports extends HttpServlet {
...
String allpath = getServletContext().getRealPath("/upi_reports.xlsx");
...
//                    
        ...
        String qry = "call internal_system.sp_pull_upi_report('"+startdate+"', '"+enddate+"');";
...
wb.setForceFormulaRecalculation(true);
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "UPI_Reports_btwn_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(upiReports.class.getName()).log(Level.SEVERE, null, ex);
