...
public class saveupi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table=" internal_system.upi_data ";
 ...
 String[] dataelementsarr= {"id","date","facility","indicatorid","bl15","ab15","ttl","userid"}; 
...
{
   out.println("UPI Data Saved succesfully ");
}
else 
{
 out.println(" Data Not successfully saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveupi.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
