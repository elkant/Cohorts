 ...
 * @author EKaunda
 */
public class saveotz extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table=" internal_system.otz_data ";
 ...
 String[] dataelementsarr= {"id","yearmonth","facility","indicatorid","_19m","_19f","ttl","userid"}; 
...
{
   out.println("OTZ Data Saved succesfully ");
}
else 
{
 out.println(" Data Not successfully saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveotz.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
