 ...
 * @author EKaunda
 */
public class loadOtzValidation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getList="select * from internal_system.otz_validation where is_active='1'  ";
           ...
           arr.add(obj);
            ...
            Logger.getLogger(loadOtzValidation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
                  }
    }
