 ...
 * @author EKaunda
 */
public class otz_missing_reports extends HttpServlet {
...
//______________________________________________________________________________________  
        ...
        sps.put(1, "Missing_OTZ_Reports@internal_system.sp_otz_missing_reports");
...
rw.setHeightInPoints(32);
        ...
        System.out.println("" + "OTZ_Tracker_reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "OTZ_Tracker_rpt_for_"+enddate+"__gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(otz_missing_reports.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
