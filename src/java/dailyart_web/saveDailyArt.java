 ...
 * @author EKaunda
 */
public class saveDailyArt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table="der_rri.der_table_age";
...
//          }
 ...
 String[] dataelementsarr= {"id","date","facility","indicatorid","sdp","f14","m14","f15","m15","value","userid","date"}; 
 String[] destelementsarr= {"id","date","mflcode","indicator_id","delivery_point","f14","m14","f15","m15","value","submitted_by","datefromfile"}; 
...
{
   out.println("Daily ART data Saved succesfully ");
}
else {
 out.println(" Data Not saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveDailyArt.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
