 ...
 * @author EKaunda
 */
public class loadDailyARTValidation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getList="select * from der_rri.dailyart_validation where is_active='1';";
           ...
           arr.add(obj);
            ...
            Logger.getLogger(loadDailyARTValidation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
                  }
    }
