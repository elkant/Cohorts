 ...
 * @author EKaunda
 */
public class me_matrix_reports extends HttpServlet {
...
String allpath = getServletContext().getRealPath("/me_matrix_report.xlsx");
...
String filepath="ME_Matrix_"+dat2+".xlsx";
...
//                    
        ...
        String qry = "call internal_system.sp_pull_me_matrix('"+startdate+"', '"+enddate+"');";
...
((XSSFSheet)shet).getCTWorksheet().getDimension().setRef("A1:G" + (shet.getLastRowNum() + 1));

CTTable ctTable = ((XSSFSheet)shet).getTables().get(0).getCTTable();

ctTable.setRef("A1:G" + (shet.getLastRowNum() + 1)); // adjust reference as needed
        ...
        System.out.println("" + "ME_Matrix_Reports_Gen_" + createdOn.trim() + ".xlsx");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "ME_Matrix_Reports_btwn_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(me_matrix_reports.class.getName()).log(Level.SEVERE, null, ex);
