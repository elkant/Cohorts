 ...
 * @author EKaunda
 */
public class saveHtsSelfData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table=" internal_system.htsself_data ";
 ...
 String[] dataelementsarr= {"id","yearmonth","facility","indicatorid","modality","value","userid"}; 
...
{
   out.println("HTS Self Data Saved succesfully ");
}
else {
 out.println(" Data Not saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveHtsSelfData.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
