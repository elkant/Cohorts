 ...
 * @author EKaunda
 */
public class loadMortIndicators extends HttpServlet {
...
if(request.getParameter("fm")!=null){fm=request.getParameter("fm");}
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(loadMortIndicators.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
String getdata=" select * from internal_system.mortality_data where  patient_id='"+patientId+"'";
...
+", ifnull(minchars,'') as minchars"
        + " from internal_system.mortality_indicators where is_active='1' and "+where+" order by order_no ";
//maxchars	isphonenumber	acceptnumbersonly	minchars
...
String qry="select  ifnull(element_id,'') as element_id,client_identifier_field,label from internal_system.mortality_indicators where is_active='1' "+where+"";
