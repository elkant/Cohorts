...
public class pullHTS extends HttpServlet {
    ...
    public String getServletInfo() {
      ...
      public String hts_pns(String startyearmonth, String endyearmonth,String facil) {
        ...
        try {
            ...
            String qry1 = "call hts_pns(\"" + startyearmonth + "\",\"" + endyearmonth + "\",\"" + facilitiestable + "\",\"" + facil + "\")";
