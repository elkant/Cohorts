 ...
 */
public class saveClinical extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table=" internal_system.clinical_data ";
          
          String mfl="";
          
          if(request.getParameter("facility_id")!=null){
          mfl=request.getParameter("facility_id");
          session.setAttribute("lastsavedfacil", mfl);
 ...
 out.println(" Data Not successfully saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveClinical.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
