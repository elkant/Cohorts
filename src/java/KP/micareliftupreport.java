 ...
 * @author EKaunda
 */
public class micareliftupreport extends HttpServlet {
...
SXSSFWorkbook wb = new SXSSFWorkbook(1000);
        ...
        Sheet shet = wb.createSheet("rawdata");
...
//                    
        ...
        String qry = "call internal_system.sp_kp_liftup_micare_rawfile_perlip('"+sd+"','"+ed+"','"+lip+"');";
...
//skip header
     ...
     if(count!=count1)   {
      ...
      //  shet.createFreezePane(6, 4);
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "Micare_andLiftup_fbetween_"+startdate+"_to_"+enddate+"_gen_" + createdOn.trim() + ".xlsx");
