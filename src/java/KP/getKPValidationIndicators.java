 ...
 * @author EKaunda
 */
public class getKPValidationIndicators extends HttpServlet {
...
String qry="select * from aphiaplus_moi.kp_indicators_validation where active='1' order by orodha asc";
