 ...
 * @author EKaunda
 */
public class loadMicareValidation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getList="select * from internal_system.micare_liftup_validation where is_active='1';";
           ...
           arr.add(obj);
            ...
            Logger.getLogger(loadMicareValidation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
                  }
    }
