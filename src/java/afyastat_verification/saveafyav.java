 ...
 * @author EKaunda
 */
public class saveafyav extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String table=" internal_system.afyav_data ";
...
{
   out.println("Verification Data Saved succesfully ");
}
else 
{
 out.println(" Data Not successfully saved ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(saveafyav.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
