 ...
 * @author EKaunda
 */
public class loadAfyaValidation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getList="select * from internal_system.afyav_validation where is_active='1'  ";
           ...
           arr.add(obj);
            ...
            Logger.getLogger(loadAfyaValidation.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
                  }
    }
